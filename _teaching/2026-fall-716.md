...
permalink: /teaching/2026-fall-716
...
Before each class you must read two papers and then write short reviews for each paper. 

#### 1 Review Submission

We will use the [HotCRP review system](https://jhu-adviot26fa.hotcrp.com/) &ndash; the same tool used by many conferences to review papers.
...
<a href="mailto:rjzhao@jhu.edu?subject=CS716-adviot26fa%20HotCRP%20Issue">e-mail me</a> with subject "CS716-adviot26fa HotCRP Issue".

#### 2 Guides

The review should be more than a simple summary of the paper (which can be easily done with the help of LLMs). In your review, you are required to cover 1 question out of each following category.

<!-- 1. What is the problem this paper addresses, and why is it important?  
2. What is the main contribution of the paper? New research direction? Novel techniques? Solid system design?  
3. What is the hypothesis of this paper?  
4. How was the paper evaluated? What supported it, what refuted it?  
5. What are the limits of this system (when does it fail)?  
6. What is the most similar work or concept that you are already familiar with; how does it compare, differ?  
7. At what point did you decide you liked – or didn't like – the paper, why?  
8. Find some connections with your background or interested fields. What kind of new applications can this work be used for?
9. What's your first impression when you see the title? Has your opinion of the paper changed after you read the paper? Specify one or two 
-->

##### Summary / Motivation

1. What problem does this paper address, and why do *you* think it matters (or doesn't)? Connect your answer to your own background, coursework, or research interests.

2. What is the paper's central hypothesis? State the hypothesis in a form that could be falsified. What result would have proven it wrong?

3. Pick one specific claim the authors make (quote it). Is it a claim about performance, generality, or mechanism? Why did that particular claim strike you as the "main point" of the paper?

##### Evidence, Limits, and Comparison

1. How was the paper evaluated, and where exactly (which figure, table, or experiment) is the evidence strongest? Where is the evidence weakest or most indirect relative to what's claimed?

2. What are the limits of this system? Find a specific failure case, edge case, or ablation result in the paper that reveals when it breaks. If none is discussed, what failure do you suspect and why?

3. You can pick one question from the pre-reading questions.

##### Personal Judgment

1. What is the most similar work or concept you already know (from this course, another paper, or your own project)? Compare and contrast specifically. Don't just say "it's similar to X," explain one concrete way it differs in method or assumption.

2. Where do you disagree with the authors' own interpretation of their results? Point to a specific passage in the discussion or conclusion and explain your disagreement using details from the paper.

3. At what point in reading did you decide you liked or didn't like the paper? What specific sentence, figure, or result triggered that reaction?

##### Reflection / Connection

1. What was your first impression from the title or abstract, and did your opinion change after reading? Give one or two concrete things that changed your mind (or confirmed your initial guess).

2. What new application in your own field of interest could this work enable or improve? Be specific about what would need to change or be adapted, not just "this could be applied to X."

3. If you could ask the authors to redirect their next paper toward one open question raised (but not answered) here, what would you propose, and why does it interest you personally rather than just being "the obvious next step"?
...
<table class="table table-bordered table-hover">
    ...
    <tr class="table-info">
        <td colspan="4">Week 8: Project and Break</td>
    </tr>
    <tr>
      <td>Oct 20</td>
    ...
    <tr>
      ...
      <td>
        ...
        <tr class="table-warning">
      <td colspan="4">Week 13: Fall Recess</td>
    </tr>
    <tr class="table-info">
      <td colspan="4">Week 14: Security and Privacy</td>
    </tr>
    <tr>
      <td>Dec&nbsp;1</td>
      <td>
    ...
    <tr>
      <td>Dec&nbsp;8</td>
      <td><a href="#">Ocean IoT</a>
      <hr />
      Pre-reading questions:
      <ul>
        <li>What is missing for exploring the ocean?</li>
        <li>Why consider underwater backscatter?</li>
        <li>What are the similar and different problems comparing to common IoT systems?</li>
      </ul>
      <td><i>TBD</i></td>
      <td>
        Read and review:
        <ul>
          <li><a href="https://dl.acm.org/doi/10.1145/3341302.3342091">Underwater backscatter networking</a></li>
          <li><a href="https://dl.acm.org/doi/10.1145/3718958.3750507">Mobile Underwater Backscatter Networking</a></li>
        </ul>
        <hr />
        For those wanting more...
        <ul>
          <li><a href="https://dl.acm.org/doi/10.1145/3570361.3613265">The Underwater Backscatter Channel: Theory, Link Budget, and Experimental Validation</a></li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr class="table-info">
      <td colspan="4">Final presentation</td>
    </tr>
    <tr class="table-warning">
      <td>Dec&nbsp;15 6-9pm</td>
      <td>Final presentation</td>
      <td colspan="2">Final report.</td>
    </tr>
</table>
    <!--
    <tr class="table-info">
